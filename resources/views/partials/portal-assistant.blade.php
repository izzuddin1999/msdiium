@php($portalAssistantIsPublic = ! request()->user())
<style>
    ...
    .portal-ai-form{padding:12px;border-top:1px solid #dde9e6;background:#fff}.portal-ai-input-row{display:flex;gap:8px;align-items:flex-end}.portal-ai-form textarea{min-height:46px!important;max-height:110px;resize:none;padding:11px 12px;font-size:13px}.portal-ai-send{flex:0 0 46px!important;width:46px!important;height:46px!important;min-height:46px!important;padding:0!important}.portal-ai-note{display:block;margin-top:6px;color:#83918e;font-size:9px;text-align:center}
...
<aside class="portal-ai-panel" id="portalAiPanel" aria-label="Portal assistant">
    <header class="portal-ai-head">
        <div class="portal-ai-identity">
            ...
            <span><strong>Policy Portal Assistant</strong><small>{{ $portalAssistantIsPublic ? 'Answers from published public records' : 'Answers from records you can access' }}</small></span>
        </div>
    ...
    <div class="portal-ai-messages" id="portalAiMessages" aria-live="polite">
        <div class="portal-ai-message assistant">Hello! Ask me about policies, circulars, topics, effective dates, requirements, or documents {{ $portalAssistantIsPublic ? 'published publicly' : 'available to you' }} in this portal.</div>
    </div>
