...
<style>
    ...
    .public-v2-section{margin-top:14px;padding:18px;border:1px solid #e0e7e9;border-radius:11px;background:rgba(255,255,255,.94);box-shadow:0 5px 17px rgba(30,60,64,.06)}.public-v2-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;margin-bottom:14px}.public-v2-heading strong{display:block;color:#006d70;font-size:11px;text-transform:uppercase;letter-spacing:.04em}.public-v2-heading p{margin:5px 0 0;color:#667085;font-size:10px}.public-v2-heading a{padding:8px 12px;border:1px solid #d9e3e5;border-radius:7px;color:#31515a;font-size:9px;font-weight:700}.topic-group-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.topic-group-card{display:grid;grid-template-columns:48px minmax(0,1fr) 20px;gap:12px;align-items:center;padding:12px;border:1px solid #dfe7ea;border-radius:9px;color:#172b4d;background:#fff}.topic-group-icon,.public-unit-icon{display:grid;place-items:center;width:48px;height:48px;border-radius:9px;background:#e6f7f3;color:#008f86}.topic-group-card:nth-child(even) .topic-group-icon{background:#eaf4ff;color:#1788c6}.topic-group-card strong,.topic-group-card small,.topic-group-card span{display:block}.topic-group-card strong{font-size:12px}.topic-group-card span{margin-top:3px;color:#344054;font-size:9px}.topic-group-card small{margin-top:4px;color:#667085;font-size:8px}.topic-group-card>.material-icons{color:#008f86}.public-unit-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.public-unit-card{display:grid;grid-template-columns:54px minmax(0,1fr) 20px;gap:12px;align-items:center;padding:15px;border:1px solid #dfe7ea;border-radius:9px;background:#fff;color:#172b4d}.public-unit-icon{width:54px;height:54px;background:#daf6ec;color:#07906f}.public-unit-card:nth-child(2) .public-unit-icon{background:#eeecff;color:#5f5bd5}.public-unit-card em{display:block;color:#007a70;font-size:8px;font-style:normal;font-weight:750;text-transform:uppercase}.public-unit-card strong{display:block;margin:3px 0;font-size:14px}.public-unit-card small{display:block;color:#667085;font-size:9px}.public-unit-card>.material-icons{color:#008f86}.public-directory-v2{scroll-margin-top:80px}.public-directory-filter{display:grid;grid-template-columns:minmax(240px,1.5fr) repeat(3,minmax(120px,.65fr)) auto;gap:8px}.public-directory-filter input,.public-directory-filter select{height:39px;padding:0 10px;border:1px solid #d7e1e4;border-radius:7px;background:#fff;font-size:10px}.public-directory-filter button{border:0;border-radius:7px;background:#008f86;color:#fff;font-size:10px;font-weight:750}.public-doc-list{margin-top:13px;border:1px solid #e0e7e9;border-radius:8px;overflow:hidden}.public-doc-item{display:grid;grid-template-columns:38px minmax(0,1fr) 100px 70px;gap:12px;align-items:center;padding:11px 13px;border-bottom:1px solid #e8edef;background:#fff}.public-doc-item:last-child{border:0}.public-doc-icon{display:grid;place-items:center;width:36px;height:36px;border-radius:7px;background:#ffecec;color:#d94141;font-size:8px;font-weight:800}.public-doc-item strong,.public-doc-item small{display:block}.public-doc-item strong{font-size:10px}.public-doc-item small{margin-top:3px;color:#667085;font-size:8px}.public-doc-date{color:#475467;font-size:9px}.public-doc-item>a{padding:6px;border:1px solid #cfe0e2;border-radius:6px;color:#00756f;text-align:center;font-size:8px;font-weight:750}.public-help{display:grid;grid-template-columns:1fr auto;align-items:center}.public-help h2{font-size:20px}.public-help p{max-width:750px;color:#667085;font-size:10px}.public-help a{padding:9px 13px;border:1px solid #007c74;border-radius:7px;color:#007c74;font-size:9px;font-weight:700}
