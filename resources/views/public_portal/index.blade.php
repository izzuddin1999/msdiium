...
<style>
    ...
    .public-v2-section{margin-top:14px;padding:22px;border:1px solid #e0e7e9;border-radius:11px;background:rgba(255,255,255,.94);box-shadow:0 5px 17px rgba(30,60,64,.06)}.public-v2-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;margin-bottom:18px}.public-v2-heading strong{display:block;color:#006d70;font-size:14px;font-weight:600;text-transform:uppercase;letter-spacing:.04em}.public-v2-heading p{margin:6px 0 0;color:#667085;font-size:13px;line-height:1.5}.public-v2-heading a{padding:9px 13px;border:1px solid #d9e3e5;border-radius:7px;color:#31515a;font-size:12px;font-weight:600}.topic-group-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.topic-group-card{display:grid;grid-template-columns:48px minmax(0,1fr) 20px;gap:12px;align-items:center;padding:12px;border:1px solid #dfe7ea;border-radius:9px;color:#172b4d;background:#fff}.topic-group-icon,.public-unit-icon{display:grid;place-items:center;width:48px;height:48px;border-radius:9px;background:#e6f7f3;color:#008f86}.topic-group-card:nth-child(even) .topic-group-icon{background:#eaf4ff;color:#1788c6}.topic-group-card strong,.topic-group-card small,.topic-group-card span{display:block}.topic-group-card strong{font-size:12px;font-weight:600}.topic-group-card span{margin-top:3px;color:#344054;font-size:9px}.topic-group-card small{margin-top:4px;color:#667085;font-size:8px}.topic-group-card>.material-icons{color:#008f86}.public-unit-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.public-unit-card{display:grid;grid-template-columns:54px minmax(0,1fr) 20px;gap:12px;align-items:center;padding:15px;border:1px solid #dfe7ea;border-radius:9px;background:#fff;color:#172b4d}.public-unit-icon{width:54px;height:54px;background:#daf6ec;color:#07906f}.public-unit-card:nth-child(2) .public-unit-icon{background:#eeecff;color:#5f5bd5}.public-unit-card em{display:block;color:#007a70;font-size:8px;font-style:normal;font-weight:600;text-transform:uppercase}.public-unit-card strong{display:block;margin:3px 0;font-size:14px;font-weight:600}.public-unit-card small{display:block;color:#667085;font-size:9px}.public-unit-card>.material-icons{color:#008f86}.public-directory-v2{scroll-margin-top:80px}.public-directory-filter{display:grid;grid-template-columns:minmax(240px,1.5fr) repeat(3,minmax(120px,.65fr)) auto;gap:10px}.public-directory-filter input,.public-directory-filter select{height:48px;padding:0 14px;border:1px solid #d7e1e4;border-radius:7px;background:#fff;font-size:14px}.public-directory-filter button{min-width:82px;border:0;border-radius:7px;background:#008f86;color:#fff;font-size:13px;font-weight:600}.public-doc-list{margin-top:17px;border:1px solid #e0e7e9;border-radius:8px;overflow:hidden}.public-doc-item{display:grid;grid-template-columns:48px minmax(0,1fr) 120px 90px;gap:16px;align-items:center;min-height:82px;padding:15px 16px;border-bottom:1px solid #e8edef;background:#fff}.public-doc-item:last-child{border:0}.public-doc-icon{display:grid;place-items:center;width:44px;height:44px;border:1px solid #cfe3df;border-radius:9px;background:#e8f7f4;color:#007b75}.public-doc-icon .material-icons{font-size:25px}.public-doc-icon.type-circular{border-color:#d6e3f5;background:#e8f2ff;color:#2367b1}.public-doc-icon.type-guideline{border-color:#f0dfbd;background:#fff5df;color:#b56b08}.public-doc-item strong,.public-doc-item small{display:block}.public-doc-item strong{color:#172b4d;font-size:14px;font-weight:500;line-height:1.45}.public-doc-item small{margin-top:5px;color:#667085;font-size:12px;line-height:1.4}.public-doc-date{color:#475467;font-size:12px}.public-doc-item>a{padding:9px 10px;border:1px solid #cfe0e2;border-radius:7px;color:#00756f;text-align:center;font-size:12px;font-weight:600}.public-help{display:grid;grid-template-columns:1fr auto;align-items:center}.public-help h2{font-size:20px}.public-help p{max-width:750px;color:#667085;font-size:10px}.public-help a{padding:9px 13px;border:1px solid #007c74;border-radius:7px;color:#007c74;font-size:9px;font-weight:600}
    .iium-portal-template .portal-name strong{font-weight:600}.iium-portal-template .sidebar-nav a.active{font-weight:500}.iium-portal-template .nav-label{font-weight:600}.iium-portal-template .portal-viewer-switch label{font-weight:600}
    .msd-public-topics{margin-top:14px;padding:20px;border:1px solid #c6d7dc;border-radius:0;background:linear-gradient(110deg,rgba(215,250,232,.96),rgba(183,224,238,.96));box-shadow:0 4px 14px rgba(30,60,64,.08)}.msd-public-topics h2{margin:0 0 16px;color:#063b68;font-size:22px;letter-spacing:0;text-transform:uppercase}.msd-public-topic-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.msd-public-topic-column{display:flex;flex-direction:column;gap:14px}.msd-public-topic-card{position:relative;border:2px solid #efc317;background:rgba(205,239,236,.48);color:#172b4d}.msd-public-topic-head{display:grid;grid-template-columns:82px minmax(0,1fr);min-height:60px;background:#ffdc55}.msd-public-topic-code{position:relative;z-index:1;display:grid;place-items:center;min-height:68px;margin:-8px 0 0 8px;padding:6px;background:linear-gradient(#5da9a3,#267c7a);color:#fff;font-size:22px;font-weight:850;line-height:1.05;text-align:center;filter:drop-shadow(0 4px 2px rgba(0,0,0,.18))}.msd-public-topic-code:after{content:'';position:absolute;bottom:-12px;left:0;width:100%;height:13px;background:#267c7a;clip-path:polygon(0 0,50% 100%,100% 0)}.msd-public-topic-head strong{display:flex;align-items:center;padding:9px 14px;font-size:17px;line-height:1.15;text-transform:uppercase}.msd-public-topic-list{margin:18px 15px 14px;padding-left:34px}.msd-public-topic-list li{margin:7px 0;font-size:16px;line-height:1.32}.msd-public-topic-list a{color:#2d405a;text-decoration:none}.msd-public-topic-list a:hover{color:#006d70;text-decoration:underline}.msd-public-topic-empty{padding:24px 18px;color:#526477;font-size:13px}
    @media(max-width:991px){.public-v2-hero{grid-template-columns:1fr}.public-record-card{display:none}.public-unit-grid{grid-template-columns:1fr}.public-directory-filter{grid-template-columns:1fr 1fr}.public-directory-filter input{grid-column:1/-1}.public-header-title{display:none}.msd-public-topic-grid{gap:14px}.msd-public-topic-list li{font-size:14px}.msd-public-topic-head strong{font-size:15px}}
...
<div class="public-v2"><div class="public-v2-container">
    ...
    <section class="msd-public-topics" id="msd-topics">
        ...
        @php
            $preferredTopicOrder = ['SM', 'SS', 'HRD', 'CB', 'OA', 'RB', 'STAFF HANDBOOK'];
        ...
        <div class="msd-public-topic-grid">
            @foreach($msdDisplayTopics->chunk((int) ceil($msdDisplayTopics->count() / 2)) as $topicColumn)
            <div class="msd-public-topic-column">
            @foreach($topicColumn as $category)
                @php
    ...
    @endif
    <section class="public-v2-section"><div class="public-v2-heading"><div><strong>Browse by directory</strong><p>Select a directory to view its published public documents</p></div></div><div class="public-unit-grid">@foreach($unitCards as $unit)<a class="public-unit-card" href="{{ $unit['url'] }}"><span class="public-unit-icon material-icons">{{ $unit['icon'] }}</span><span><strong>{{ $unit['code'] }}</strong><small>{{ $unit['name'] }} · {{ $unit['documents'] }} {{ Str::plural('document',$unit['documents']) }}</small></span><span class="material-icons">arrow_forward</span></a>@endforeach</div></section>
    <section class="public-v2-section public-directory-v2" id="directory"><div class="public-v2-heading"><div><strong>Document directory</strong><p>Search and filter the latest published public versions</p></div></div><form id="advanced-search" class="public-directory-filter" method="GET" action="{{ route('public-portal') }}"><input name="q" value="{{ request('q') }}" placeholder="Title, reference number or keyword"><select name="year"><option value="">All years</option>@foreach($years as $year)<option value="{{ $year }}" @selected((string)request('year')===(string)$year)>{{ $year }}</option>@endforeach</select><select name="category"><option value="">All topics</option>@foreach($categories as $category)<option value="{{ $category }}" @selected(request('category')===$category)>{{ str($category)->replace(['_','-'],' ')->title() }}</option>@endforeach</select><select name="type"><option value="">All types</option>@foreach($types as $type)<option value="{{ $type }}" @selected(request('type')===$type)>{{ str($type)->title() }}</option>@endforeach</select><button>Search</button></form><div class="public-doc-list">@forelse($documents as $document)<article class="public-doc-item"><span class="public-doc-icon type-{{ $document->document_type }}" aria-hidden="true"><span class="material-icons">{{ $document->document_type === 'circular' ? 'campaign' : ($document->document_type === 'guideline' ? 'menu_book' : 'description') }}</span></span><span><strong>{{ $document->title }}</strong><small>{{ $document->reference_number ?: 'No official reference' }} · {{ str($document->document_type)->title() }}</small></span><span class="public-doc-date">{{ ($document->effective_date ?? $document->published_at)?->format('d M Y') ?? 'Current' }}</span><a href="{{ route('public.documents.show',$document) }}">View →</a></article>@empty<div class="empty-state"><strong>No public documents found</strong><p>Try another search term or filter.</p></div>@endforelse</div>@if($documents->hasPages())<nav class="pagination">{{ $documents->links() }}</nav>@endif</section>
...
<section class="msd-topics" id="topics">
    <div class="portal-container">
        <div class="msd-topics-heading"><div><h2>Categories of Topics</h2></div><p>Browse the official Management Services Division topic structure. Select a main topic to filter the public document directory.</p></div>
...
<section class="staff-workspace" id="staff-workspace">
    <div class="portal-container">
        ...
        <section class="staff-unit-browser" aria-labelledby="staff-unit-browser-title">
            <div class="staff-unit-browser-heading"><span><strong id="staff-unit-browser-title">Browse document directories</strong><small>Open the documents available to you under MSD or AIKOL.</small></span><span class="material-icons">account_tree</span></div>
    ...
    <div class="portal-container">
        ...
        <section class="unit-directory" aria-labelledby="unit-directory-title">
            <div class="unit-directory-heading">
                <div><span class="eyebrow">PUBLIC DOCUMENT DIRECTORY</span><h2 id="unit-directory-title">Browse by directory</h2>
                @if($selectedUnit)<a class="all-units-link" href="{{ route('public-portal') }}#directory"><span class="material-icons">apps</span>View all directories</a>@else<span class="unit-total">{{ $allDocumentCount }} public {{ str('record')->plural($allDocumentCount) }}</span>@endif
            </div>
            <div class="unit-card-grid">
                @foreach($unitCards as $unit)
                    <a class="unit-card {{ ($selectedOrganization?->id ?? null) === $unit['id'] ? 'selected' : '' }}" href="{{ $unit['url'] }}" @if(($selectedOrganization?->id ?? null) === $unit['id']) aria-current="page" @endif>
                        <span class="unit-card-icon material-icons">{{ $unit['icon'] }}</span>
                        <span class="unit-card-copy"><span class="unit-code">{{ $unit['code'] }}</span><strong>{{ $unit['name'] }}</strong><small>{{ $unit['latest'] ? 'Latest: '.$unit['latest'] : 'No public publications yet' }}</small></span>
        ...
        <div class="section-heading">
            <div><span class="eyebrow">DOCUMENT DIRECTORY</span><h2>{{ $viewer ? 'Your accessible documents' : ($selectedUnit === 'msd' ? 'MSD public documents' : ($selectedUnit === 'kcdiom' ? 'AIKOL public documents' : 'Find an official document')) }}</h2><p>{{ $viewer ? 'Search the latest documents available to you.' : 'Only the latest published public version is shown.' }}</p></div>
        </div>
                ...
                <section class="year-group">
                    ...
                    @foreach($yearDocuments as $document)
                        ...
                        <article class="document-row">
                            <div class="doc-icon" aria-hidden="true"><span class="material-icons">{{ $document->document_type === 'circular' ? 'campaign' : ($document->document_type === 'guideline' ? 'menu_book' : 'description') }}</span></div>
